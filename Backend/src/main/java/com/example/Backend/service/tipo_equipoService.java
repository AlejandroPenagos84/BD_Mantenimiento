...
import com.example.backend.DAOs.implemetaciones.tipo_equipoDAOImpl;
...
public class tipo_equipoService {
    ...
    public List<tipo_equipoDTO> getAll(String user, String password) {
        conexionBD conexionBD = new conexionBD(user, password);

        try (Connection conn = conexionBD.obtenerConexion()) {
            tipo_equipoDAO dao = new tipo_equipoDAOImpl(conn);
            return dao.findAll();
    ...
    public Optional<tipo_equipoDTO> getById(String user, String password, String id) {
        conexionBD conexionBD = new conexionBD(user, password);
    ...
    public void save(String user, String password, tipo_equipoDTO entity) {
        conexionBD conexionBD = new conexionBD(user, password);
    ...
    public void update(String user, String password, String id, tipo_equipoDTO entity) {
        conexionBD conexionBD = new conexionBD(user, password);

        try (Connection conn = conexionBD.obtenerConexion()) {
            tipo_equipoDAO dao = new tipo_equipoDAOImpl(conn);
            if (dao.findById(id) == null) {
                throw new RuntimeException("tipo_equipo con ID " + id + " no encontrado.");
            }
